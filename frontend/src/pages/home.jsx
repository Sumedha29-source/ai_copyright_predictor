...
│   │   ├── 1      → file selected
│   │   ├── 2      → AI analyzing
│   │   ├── 3      → blockchain writing
│   │   └── 4      → complete
│   │
│   ├── file       → selected file object
│   ├── preview    → image preview URL
│   ├── analyzing  → is verifying
...
│
├── handleAnalyze()
│   ├── sets step 2  → AI analyzing
│   ├── waits 3s
│   ├── sets step 3  → blockchain
│   ├── waits 2s
│   ├── generates result
│   └── sets step 4  → done
│
...
│
├── Upload Tab
│   ├── StepProgress    → always visible
│   ├── UploadZone      → step 0 and 1
│   ├── AnalyzingState  → step 2 (AI)
│   ├── AnalyzingState  → step 3 (blockchain)
│   └── ResultCard      → step 4
│
└── History Tab
...
Step 0 — Initial state
  Shows: UploadZone (empty)

Step 1 — File selected
  Shows: UploadZone (with preview)

Step 2 — AI analyzing
  Shows: AnalyzingState phase="ai"
  Lasts: 3 seconds

Step 3 — Writing to blockchain
  Shows: AnalyzingState phase="blockchain"
  Lasts: 2 seconds

Step 4 — Complete
  Shows: ResultCard with score + hash
  ```